...
| --- | --- |
| A question about how to use the SDK, or a design question | [GitHub Discussions](https://github.com/JEV/typesafe-dotnet-sdk/discussions) |
| A bug in the SDK, with a reproduction | [Bug report](https://github.com/JEV/typesafe-dotnet-sdk/issues/new?template=bug_report.yml) |
| An idea for a capability the SDK lacks | [Feature request](https://github.com/JEV/typesafe-dotnet-sdk/issues/new?template=feature_request.yml), or a Discussion first if the shape is unclear |
